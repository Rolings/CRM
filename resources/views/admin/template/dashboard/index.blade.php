...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('admin/js/progress-bar/number-pb.css') }}">
@endsection
@section('content')
...
@section('style_after')
    ...
    <script src="{{ asset('admin/js/speed/canvasgauge-coustom.js') }}"></script>
    <script src="{{ asset('admin/js/countdown/jquery.countdown.js') }}"></script>
